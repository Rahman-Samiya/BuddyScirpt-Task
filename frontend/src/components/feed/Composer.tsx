  ...
  const handleSubmit = async () => {
    if (!content.trim() && !selectedImage) {
      Swal.fire({
        ...
        position: 'top-end',
        icon: 'warning',
        title: 'Please write something or select an image',
        showConfirmButton: false,
        timer: 3000,
        timerProgressBar: true,
        customClass: {
    ...
    if (content.length > 1000) {
      Swal.fire({
        ...
        position: 'top-end',
        icon: 'warning',
        title: 'Content should be less than 1000 characters',
        showConfirmButton: false,
        timer: 3000,
        timerProgressBar: true,
        customClass: {
