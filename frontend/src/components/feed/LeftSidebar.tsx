        ...
        <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <ul className="_left_inner_area_explore_list">
            <li className="_left_inner_area_explore_item _explore_item">
              <Link href="/profile" className="_left_inner_area_explore_link">
        ...
        <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_area_suggest_content _mar_b24">
            ...
            <span className="_left_inner_area_suggest_content_txt">
              <Link href="/profile" className="_left_inner_area_suggest_content_txt_link">See All</Link>
            </span>
          </div>
          {[1, 2, 3].map((i) => (
            <div key={i} className="_left_inner_area_suggest_info">
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link href="/profile">
                    <img src={`/assets/images/people${i}.png`} alt="Image" className={i === 1 ? "_info_img" : "_info_img1"} />
                  </Link>
                </div>
                <div className="_left_inner_area_suggest_info_txt">
                  <Link href="/profile">
                    <h4 className="_left_inner_area_suggest_info_title">
                      {i === 1 ? "Steve Jobs" : i === 2 ? "Ryan Roslansky" : "Dylan Field"}
                    </h4>
                  </Link>
                  <p className="_left_inner_area_suggest_info_para">
                    {i === 1 ? "CEO of Apple" : i === 2 ? "CEO of Linkedin" : "CEO of Figma"}
                  </p>
                </div>
              </div>
              <div className="_left_inner_area_suggest_info_link">
                <Link href="/profile" className="_info_link">Connect</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_event_content">
            ...
            <Link href="/profile" className="_left_inner_event_link">See all</Link>
          </div>

          {[1, 2].map((i) => (
            <Link href="/profile" key={i} className="_left_inner_event_card_link">
